...
def main(main_args):
    ...
    if dataset_name == 'streamspot' or dataset_name == 'wget':
        ...
        ck_path = "./checkpoints_cl/checkpoint-{}_ncl{}_sr{}_gcl{}_d{}_l{}_v{}_s{}_n{}_epoch{}_alp{}_bta{}.pt".format(dataset_name,main_args.ncl,main_args.sr,
                       main_args.gcl, main_args.num_hidden,main_args.num_layers, main_args.views,main_args.strategy,main_args.nid_batch_size, main_args.max_epoch,main_args.alpha,main_args.beta)
        ...
        with torch.no_grad():
            ...
            test_auc, test_std, _, _ = evaluate_entity_level_using_knn(dataset_name, x_train, result_x_test,
                                                                       result_y_test, device = main_args.device)
